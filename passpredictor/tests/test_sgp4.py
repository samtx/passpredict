...
# from passpredictor.sgp4io import wgs72
# from passpredictor.sgp4io import invjday, newtonnu, rv2coe
# import passpredictor.sgp4io as io
...
# thisdir = os.path.join(os.path.dirname(__file__), 'data')
# error = 2e-7
# rad = 180.0 / pi
